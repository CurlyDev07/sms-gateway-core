...
class DashboardApiBridgeTest extends TestCase
{
    ...
    public function test_dashboard_api_requires_tenant_session_binding(): void
    {
    ...
    public function test_dashboard_api_uses_server_side_tenant_binding(): void
    {
        ...
        [$apiClient] = $this->createApiClient($company);
        ...
        $this->actingAs($user)
            ->withSession(['dashboard_api_client_id' => $apiClient->id])
            ->getJson('/dashboard/api/sims')
            ->assertOk()
